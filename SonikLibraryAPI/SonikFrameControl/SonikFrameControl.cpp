...
//		};
	...
	SonikFrameControl::SonikFrameControl(unsigned long SetFrameRate)
...
//		};
	...
	SonikFrameControl::SonikFrameControl(unsigned long SetFrameRate, unsigned long SetSampleCount)
	:FrameRate(SetFrameRate)
	,FrameCount(0)
	,FrameStartTime(0)
	,OneFrameStartTime(0)
