...
namespace SonikLib
{
	...
	public:
		...
		SonikString(SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_, SonikLibStringConvert::SonikLibConvertLocale _setlocale_ = SonikLibStringConvert::SonikLibConvertLocale::LC_JPN);
		...
		SonikString(const char* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		SonikString(const char16_t* SetStr);
		SonikString(const char16_t* SetStr, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		SonikString(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_);
		SonikString(const char16_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const wchar_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const utf8_t* SetStr, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const int8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const uint8_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const int16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const uint16_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const int32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const uint32_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const int64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const uint64_t SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const float SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);
		...
		SonikString(const double SetValue, SonikLibStringConvert::SonikLibConvertLocale _setlocale_, SonikLib::AllocatorSharedSmtPtr<SonikLib::SLibAllocateInterface> _allocator_);

		//ムーヴコンストラクタ
		SonikString(SonikString&& _move_) noexcept;
		SonikString(SonikStringWIDE&& _move_) noexcept;
		SonikString(SonikStringUTF8&& _move_) noexcept;
		SonikString(SonikStringUTF16&& _move_) noexcept;
		...
		SonikString& operator =(SonikString&& _move_) noexcept;
		SonikString& operator =(SonikStringWIDE&& _move_) noexcept;
		SonikString& operator =(SonikStringUTF8&& _move_) noexcept;
		SonikString& operator =(SonikStringUTF16&& _move_) noexcept;
