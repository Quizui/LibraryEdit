...
#include <cstdint>
    ...
    #define __SONIKLIB_MATHBIT_BITFUNCTION_GCC_OTHER__
        ...
        #undef __SONIKLIB_MATHBIT_BITFUNCTION_GCC_OTHER__
...
#if defined(__SONIKLIB_MATHBIT_BITFUNCTION_GCC_OTHER__)
        return static_cast<int16_t>(31 - __builtin_clz(BitValue));

#elif defined(__SONIKLIB_MATHBIT_BITFUNCTION_WINDOWS_OTHER__)
        uint32_t index = 0;
        _BitScanReverse(reinterpret_cast<unsigned long*>(&index), BitValue);
        return static_cast<int16_t>(index);

#elif defined(__SONIKLIB_MATHBIT_BMI_BITFUNCTION_SUPPORTED__)
        return static_cast<int16_t>(31 - __lzcnt_u32(BitValue));
...
#if defined(__SONIKLIB_MATHBIT_BITFUNCTION_GCC_OTHER__)
        return static_cast<int16_t>(63 - __builtin_clzll(BitValue));

#elif defined(__SONIKLIB_MATHBIT_BITFUNCTION_WINDOWS_OTHER__)
        uint32_t index = 0;
        _BitScanReverse64(reinterpret_cast<unsigned long*>(&index), BitValue);
        return static_cast<int16_t>(index);

#elif defined(__SONIKLIB_MATHBIT_BMI_BITFUNCTION_SUPPORTED__)
        return static_cast<int16_t>(63 - __lzcnt_u64(BitValue));
...
#if defined(__SONIKLIB_MATHBIT_BITFUNCTION_GCC_OTHER__)
        return static_cast<int16_t>(__builtin_ctz(BitValue));

#elif defined(__SONIKLIB_MATHBIT_BITFUNCTION_WINDOWS_OTHER__)
        uint32_t index = 0;
        _BitScanForward(reinterpret_cast<unsigned long*>(&index), BitValue);
        return static_cast<int16_t>(index);

#elif defined(__SONIKLIB_MATHBIT_BMI_BITFUNCTION_SUPPORTED__)
        return static_cast<int16_t>(__tzcnt_u32(BitValue));
...
#if defined(__SONIKLIB_MATHBIT_BITFUNCTION_GCC_OTHER__)
        return static_cast<int16_t>(__builtin_ctzll(BitValue));

#elif defined(__SONIKLIB_MATHBIT_BITFUNCTION_WINDOWS_OTHER__)
        uint32_t index = 0;
        _BitScanForward64(reinterpret_cast<unsigned long*>(&index), BitValue);
        return static_cast<int16_t>(index);

#elif defined(__SONIKLIB_MATHBIT_BMI_BITFUNCTION_SUPPORTED__)
        return static_cast<int16_t>(__tzcnt_u64(BitValue) + 1);
...
#elif defined(__SONIKLIB_MATHBIT_BMI_BITFUNCTION_SUPPORTED__)
        return static_cast<int16_t>(__tzcnt_u64(~BitValue));
